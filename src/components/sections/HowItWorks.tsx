...
const steps = [
  {
    ...
    title: "Пишете нам",
    description:
      "Отправляете сообщение в WhatsApp утром. Рассказываете о бизнесе и целях — никаких брифов, просто диалог.",
    detail: "Утро",
  },
  {
    number: "02",
    ...
    description:
      "Разрабатываем дизайн и верстаем сайт в тот же день. Показываем промежуточный результат, вносим правки по ходу.",
    detail: "День",
  },
  {
    number: "03",
    ...
    description:
      "Вечером публикуем сайт, настраиваем домен и хостинг, передаём все доступы. Вы уже онлайн.",
    detail: "Вечер",
  },
];
